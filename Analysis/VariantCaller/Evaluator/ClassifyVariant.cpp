...
void Evaluator::SetupAllAlleles(
...
void Evaluator::FilterAllAlleles(const ClassifyFilters &filter_variant, const vector<VariantSpecificParams>& variant_specific_params) {
